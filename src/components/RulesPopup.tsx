    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
      <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl p-4 sm:p-8 max-w-xs sm:max-w-2xl max-h-[80vh] overflow-y-auto w-full">
        <div className="flex justify-between items-center mb-4 sm:mb-6">
          <h2 className="text-xl sm:text-3xl font-bold text-emerald-600">ゲームルール</h2>
          <button
            onClick={onClose}
        ...
        <div className="space-y-4 sm:space-y-6 text-gray-700 text-sm sm:text-base">
          {/* 基本ルール */}
          <section>
            <h3 className="text-lg sm:text-xl font-bold text-emerald-500 mb-2 sm:mb-3">🎯 基本ルール</h3>
          ...
          {/* Connect4+ルール */}
          <section>
            <h3 className="text-lg sm:text-xl font-bold text-emerald-500 mb-2 sm:mb-3">⭐ Connect4+ルール</h3>
            <ul className="space-y-1 sm:space-y-2 ml-4">
          ...
          {/* スコアシステム */}
          <section>
            <h3 className="text-lg sm:text-xl font-bold text-emerald-500 mb-2 sm:mb-3">🏆 スコアシステム</h3>
            <ul className="space-y-1 sm:space-y-2 ml-4">
          ...
          {/* AI戦について */}
          <section>
            <h3 className="text-lg sm:text-xl font-bold text-emerald-500 mb-2 sm:mb-3">🤖 AI戦について</h3>
            <ul className="space-y-1 sm:space-y-2 ml-4">
              <li>• <strong>ぽとり和尚（初級）</strong>: ランダムにコマを配置。</li>
              <li>• <strong>スジノ・カタル（中級）</strong>: 基本的な攻防を考慮。</li>
              <li>• <strong>ジラフ・ロウ（上級）</strong>: 2手先読みで戦略的思考。</li>
              <li>• <strong>シェイド・フォー（最強）</strong>: 6手先読みで高度な戦略。</li>
            </ul>
          </section>

          {/* 操作説明 */}
          <section>
            <h3 className="text-lg sm:text-xl font-bold text-emerald-500 mb-2 sm:mb-3">🎮 操作方法</h3>
            <ul className="space-y-1 sm:space-y-2 ml-4">
          ...
          {/* ヒント */}
          <section>
            <h3 className="text-lg sm:text-xl font-bold text-emerald-500 mb-2 sm:mb-3">💡 ヒント</h3>
            <ul className="space-y-1 sm:space-y-2 ml-4">
